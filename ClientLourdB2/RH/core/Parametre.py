...
ListeDynamiqueButtonDepartement = ['ListeDynamiqueButton','Departement','Departement','libelle_service','id_service_service','Null','Service','service']
...
FrameImageTest_accueil = ['Frame','ImageTest','Accueil',2,GROOVE,5,5,TOP]
FenetreAccueil.append(FrameImageTest_accueil)
ImageTest_accueil = ['Image','ImageTest','ImageTest','img/Moscovitch_logo.png']
FenetreAccueil.append(ImageTest_accueil)
...
ListeDynamiqueButtonServiceSelec = ['ListeDynamiqueButton','ServiceSelec','ServiceSelec','libelle_service','id_service_service','#SelectedButton#','Service','service']
...
ButtonServiceCreer = ['Button','ServiceCreer','ServiceCreer','Ajouter un service',FonctionQuiFoutRien,TOP,5,5,'AjouterUnService']
FenetreServiceSelec.append(ButtonServiceCreer)

FrameImageTest_Service = ['Frame','ImageTest','Service',2,GROOVE,5,5,TOP]
FenetreServiceSelec.append(FrameImageTest_Service)
ImageTest_Service = ['Image','ImageTest','ImageTest','img/Moscovitch_logo.png']
FenetreServiceSelec.append(ImageTest_Service)
...
ListDeroulandeVille = ['ListeDeroulante','Ville','Ville','libelle_Ville','ville',LEFT,'readonly']
FenetreAjoutEmploye.append(ListDeroulandeVille)

FrameValiderRecrutement = ['Frame','ValiderRecrutement','Employe',2,GROOVE,5,5,TOP]
FenetreAjoutEmploye.append(FrameValiderRecrutement)
ButtonValiderRecrutement = ['Button','ValiderRecrutement','ValiderRecrutement','Valider',Connection,LEFT,5,5,'Accueil']
FenetreAjoutEmploye.append(ButtonValiderRecrutement)

FrameRecrutement = ['Frame','Recrutement','Employe',2,GROOVE,5,5,TOP]
FenetreAjoutEmploye.append(FrameRecrutement)
ImageRecrutement = ['Image','Recrutement','Recrutement','img/Moscovitch_logo.png']
FenetreAjoutEmploye.append(ImageRecrutement)
