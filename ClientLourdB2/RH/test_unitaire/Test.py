...
FrameFormualireLabel = ['Frame','FormualireLabel',None,2,GROOVE,5,5,LEFT]
...
Framedwfdf = ['Frame','dwfdf',None,2,GROOVE,5,5,LEFT]
Fenetredwfdf = [Framedwfdf]


Buttonsdfds = ['Button','sdfds','sdfdsfsd','fdsdf',fdsf,dsfds,5,5,'dsfdsf']
Fenetredwfdf.append(Buttonsdfds)


# 

Framecxvcxv = ['Frame','cxvcxv',None,2,GROOVE,5,5,LEFT]
Fenetrecxvcxv = [Framecxvcxv]
